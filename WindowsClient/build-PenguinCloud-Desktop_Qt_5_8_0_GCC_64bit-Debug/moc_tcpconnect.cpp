...
#include "../PenguinCloud/logic/tcpconnect.h"
...
void TcpConnect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TcpConnect *_t = static_cast<TcpConnect *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject TcpConnect::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_TcpConnect.data,
      qt_meta_data_TcpConnect,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TcpConnect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TcpConnect.stringdata0))
        return static_cast<void*>(const_cast< TcpConnect*>(this));
